...
export const courseMeta = slopCourseMetaSchema.parse({
  code: "SLOP8038",
  title: "The Theology of Brain Rot",
  session: "Semester 1",
  year: 2027,
  level: 8,
  ...
  endDate: "2027-05-28",
  description:
    "A systematic theology of the terminally online. Twelve weeks of doctrine " +
    "train the full practice: wasting time online, engaging in AI slop, " +
    "spreading misinformation, rage-baiting, riding trends before they die, " +
    "doomscrolling past your limits, and recruiting others into the faith.",
  tags: ["theology", "internet culture", "satire"],
